...
namespace FasmNET.Tests
{
    ...
    {
        /// <summary>Gets the version of the compiler.</summary>
        [TestMethod]
        ...
        /// <summary>Assembles mnemonics and checks all is right.</summary>
        [TestMethod]
        public void Assemble()
        {
            // Act
            System.Byte[] asm = FasmNet.Assemble("use32\nretn");
            // Assert
            Assert.AreEqual(0xc3, asm[0]);
        }
        /// <summary>Assembles wrong mnemonics and check the error.</summary>
        [TestMethod]
        ...
        /// <summary>Assembles 64-bit mnemonics using an array.</summary>
        [TestMethod]
        public void Assemble64BitWithArray()
        {
            ...
            // Act
            System.Byte[] asm = FasmNet.Assemble(mnemonics);
            // Assert
            Assert.AreEqual(0x50, asm[0]);
        }
        /// <summary>Assembles a file.</summary>
        [TestMethod]
        ...
        /// <summary>Assembles some files.</summary>
        [TestMethod]
        ...
        /// <summary>Create an instance of the object and checks the methods AddLine, InsertLine.</summary>
        [TestMethod]
        public void ObjectAddAndInsertLines()
        {
            ...
            System.Byte[] asm = fasm.Assemble();
            // Assert
            CollectionAssert.AreEqual(new byte[] { 0x50, 0x58 }, asm);
        }
        /// <summary>Create an instance of the object and checks the property Mnemonics.</summary>
        [TestMethod]
        ...
        /// <summary>Create an instance of the object and checks the method Clear. </summary>
        [TestMethod]
        ...
        /// <summary>Create an instance of the object and checks the assmble result with an origin.</summary>
        [TestMethod]
        public void ObjectAssembleWithOrigin()
        {
            ...
            System.Byte[] asm = fasm.Assemble(new IntPtr(0x1000));
            // Assert
