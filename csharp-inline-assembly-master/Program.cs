...
using Process_ = System.Diagnostics.Process;
...
namespace CSharp_Inline_Assembly
{
    ...
    class Program
    {
        ...
        {
            _currentProcess = new ProcessSharp(System.Diagnostics.Process.GetCurrentProcess(), Process.NET.Memory.MemoryType.Local);
        ...
        private static void Example1()
        {
            ...
            AssemblyConstantValueFunction myAssemblyFunction = Marshal.GetDelegateForFunctionPointer<AssemblyConstantValueFunction>(allocatedCodeMemory.BaseAddress);
